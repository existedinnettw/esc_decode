...
```bash
uv run python -m esc_decode ./tests/data/decoder--250531-232808.csv -th 10 -i 0x0 0x910
```
...
```shell
uv run python -m nuitka --onefile --standalone --lto=yes --static-libpython=auto --assume-yes-for-downloads esc_decode --jobs=8
```
